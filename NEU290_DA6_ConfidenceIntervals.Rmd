---
title: "NEU290 Data Assignment 6: Confidence Intervals"
name: "Bailey Lynch"
...
**A: Chloroquine reduced cell counts on average by 626.22 relative to the control condition in our data.**
...
**D: We know that chloroquine would reduce cell counts on average by 626.22 relative to the control condition in the total real population of cells**
...
**B: We don't know how much smaller exactly the average cell count was for chloroquine than for the control condition in our data but it is plausibly between around 742 and 521 cells on average.**
...
**C: We don't know the exact average weight of newborns in our 800 newborn data set, but we know that the average for that data is between 7.1 and 7.3 lbs.**
...
**A: In all our plausible guesses for the slope, the ipsilateral hippocampus tends to decrease in size for people who have been diagnosed with epilepsy for longer.**
